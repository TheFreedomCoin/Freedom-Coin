...
#endif
	setObjectName("Freedomcoin");
	setStyleSheet("#Freedomcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
	...
	aboutAction = new QAction(QIcon(":/icons/aboutFreedomcoin"), tr("&About Freedomcoin"), this);
...
{
	QString strTitle = tr("Freedomcoin") + " - ";
