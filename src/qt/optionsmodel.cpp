...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeFreedomcoinAmount"))
        settings.setValue("nAnonymizeFreedomcoinAmount", 1000);
    nAnonymizeFreedomcoinAmount = settings.value("nAnonymizeFreedomcoinAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeFreedomcoinAmount"))
        SoftSetArg("-anonymizeFreedomcoinamount", settings.value("nAnonymizeFreedomcoinAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeFreedomcoinAmount:
            return QVariant(nAnonymizeFreedomcoinAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeFreedomcoinAmount:
            nAnonymizeFreedomcoinAmount = value.toInt();
            settings.setValue("nAnonymizeFreedomcoinAmount", nAnonymizeFreedomcoinAmount);
            emit AnonymizeFreedomcoinAmountChanged(nAnonymizeFreedomcoinAmount);
            break;
        default:
            break;
        }
