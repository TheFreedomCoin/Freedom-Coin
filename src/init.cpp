...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: Freedomcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: Freedomcoind.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeFreedomcoinamount=<n> " + _("Keep N Freedomcoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Freedomcoin is probably already running."), strDataDir));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Freedomcoin version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    nAnonymizeFreedomcoinAmount = GetArg("-anonymizeFreedomcoinamount", 0);
    if(nAnonymizeFreedomcoinAmount > 999999) nAnonymizeFreedomcoinAmount = 999999;
    if(nAnonymizeFreedomcoinAmount < 2) nAnonymizeFreedomcoinAmount = 2;
    ...
    LogPrintf("Anonymize Freedomcoin Amount %d\n", nAnonymizeFreedomcoinAmount);
